...
import type { Vehicle, Driver, Requisition, Role, AdminUser, ActivityLogEntry, Message } from "./types";
 ...
 * text now, so it's no longer trusted for ownership. Admins can cancel any
 * request by passing isAdmin = true.
 */
