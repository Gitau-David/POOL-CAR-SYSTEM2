...
// admins run allocation, fleet, and the audit trail. Dashboard, Transaction
// History, and Messages are shared, since both roles need those views.
type NavItem = {
  href: string;
  label: string;
...
const NAV_GROUPS: { label: string | null; items: NavItem[] }[] = [
  {
    label: null,
    items: [{ href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["user", "admin"] }],
  },
  {
    label: "Requests",
    items: [
  ...
  },
  {
    label: "Admin",
    items: [
      { href: "/admin/allocate", label: "Allocate Vehicle", icon: ClipboardCheck, roles: ["admin"] },
      { href: "/admin/fleet", label: "Manage Fleet", icon: Truck, roles: ["admin"] },
      { href: "/admin/activity", label: "Activity Log", icon: ScrollText, roles: ["admin"] },
    ],
  },
  {
    label: "Records",
    items: [
      { href: "/transactions", label: "Transaction History", icon: History, roles: ["user", "admin"] },
      { href: "/messages", label: "Messages", icon: MessageSquare, roles: ["user", "admin"] },
    ],
  },
];
